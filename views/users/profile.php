...
<div class="container">
    ...
    foreach ($items as $item):
        ...
        <div class="jumbotron">
            ...
            <?php echo '<p class="lead" Пароль>', $item->password, '</p>', $item->firstname, '<br>', '<span>',
            $item->lastname, '<span>'; ?>
        </div>
    <?php endforeach; ?>
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <?php echo '<a href="?ctrl=users&action=update&id=' . $item->id ?>" class="btn btn-primary"> Изменить
            профиль</a>
            <?php echo '<a href="?ctrl=users&action=delete&id=' . $item->id ?>" class="btn btn-danger">Удалить
            профиль</a>
        </div>
    </div>
